...
3. **PHYSICAL CREATION**
    ...
    The function **display_output** prints lines in the format that I use for threading. To explain the output of this function, I will use a sample from my David Bowie project, as well as an image of the actual physical implementation:
